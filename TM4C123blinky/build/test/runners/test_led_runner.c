...
extern void test_when_the_led_is_turned_on_then_port_f_pin_2_is_set(void);
extern void test_when_the_led_is_turned_off_then_port_f_pin_2_is_set_to_zero(void);
